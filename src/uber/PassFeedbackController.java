 ...
 * @author Tamim
 */
public class PassFeedbackController implements Initializable {

    @FXML
    private TextArea passengerfeedback;
    private Scene scene;
    private Stage stage;
    private Parent root;
